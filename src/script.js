 ...
 */
//Render target
let RenderTargetClas = null
if (renderer.getPixelRatio() === 1 && renderer.capabilities.isWebGL2) {
    RenderTargetClas = THREE.WebGLMultisampleRenderTarget
} else {
    RenderTargetClas = THREE.WebGLRenderTarget
}
...
const DisplacementShader = {
    ...
    fragmentShader: `
        ...
        void main()
        {
            ...
            vec2 newUv = vUv + normalColor.xy * 0.3;
            vec4 color = texture2D(tDiffuse, newUv);
            
            vec3 lightDirection = normalize(vec3(-1.0, 1.0, 0.1));
